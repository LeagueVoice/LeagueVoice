...
// from the Riot API.
const getBySummonerName = function(name, region) {
  const options = {
    method: 'GET',
...
const getRecentMatchList = function(accountID, region) {
  const options = {
    method: 'GET',
...
const getMatch = function(matchID, region) {
  const options = {
    method: 'GET',
...
const getAllLeaguePositionsForSummoner = function(summonerID, region) {
  const options = {
    method: 'GET',
...
const getAllChampionMasteriesForSummoner = function(summonerID, region) {
	const options = {
		method: 'GET',
 ...
 */
const getGGChampionsForRole = function (position, rank = 'PLATINUM') {
  const options = {
    method: 'GET',
...
const rateSignificance = function(winrate, n) {
...
const getChampionID = function(championName) {
...
// champion ID.
const getChampionName = function(championID) {
...
const getBestMatchupsByLane = function(championID, rank = 'PLATINUM') {
  const options = {
    method: 'GET',
